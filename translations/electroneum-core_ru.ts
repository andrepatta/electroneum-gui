...
<context>
    ...
    <message>
        ...
        <translation>Это облегчает отправку и получение Electroneum и снижает количество ошибок при вводе адресов вручную.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ПРЕДУПРЕЖДЕНИЕ: Не используйте повторно свои ключи Electroneum на другом форке, ЕСЛИ ТОЛЬКО этот форк не имеет встроенные средства защиты от компрометации введенных ключей. Подобные действия могут повредить вашей конфиденциальности.</translation>
    </message>
    <message>
        ...
        <translation>ВНИМАНИЕ: Копирование вашей мнемонической фразы в буфер обмена может сопровождаться перехватом этих данных различным вредоносным программным обеспечением, которое отправит вашу мнемонику злоумышленнику, после чего ваши Electroneum могут быть украдены. Пожалуйста, вводите вашу мнемоническую фразу вручную с клавиатуры.</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some Electroneum. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Майнинг на вашем компьютере помогает укрепить сеть Electroneum. Чем больше людей майнят, тем сложнее атаковать сеть, каждый может помочь.

Майнинг также даёт маленький шанс получить Electroneum. Ваш компьютер будет создать хеши в поиске решения блока. Если вы найдёте блок, то получите награду. Удачи!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Встроенная версия Electroneum: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Использовать сторонний узел для подключения к сети Electroneum. Менее безопасно, но более быстро и удобно.</translation>
    </message>
    <message>
        ...
        <translation>Чтобы получить список удаленных нод, введите &apos;Electroneum remote node&apos; в вашем любимом поисковике. Пожалуйста, убедитесь, что выбранной ноде можно доверять.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На этой странице можно взаимодействовать с общей базой данных RingDB. Эта база данных предназначается для использования кошельками Electroneum или их клонов, которые смогут повторно использовать ключи Electroneum.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того чтобы скрыть какие входы в транзакциях Electroneum потрачены, третья сторона не должна сообщать какие входы в кольце уже задействованы в трате. Ведь если это сделать, то это ослабит защиту, обеспечиваемую кольцевыми подписями. Если известно, что все, кроме одного из входов, уже потрачены, то фактически трата входа становится очевидной, тем самым аннулируется эффект кольцевых подписей, одного из трех основных уровней защиты конфиденциальности Electroneum.&lt;br&gt;Чтобы помочь транзакциям избежать траты этих входов, можно использовать список известных израсходованных выходов, чтобы избежать их использования в новых транзакциях. Такой список поддерживается проектом Electroneum и доступен нelectroneumсайте getmonero.org, и вы можете импортировать этот список здесь.&lt;br&gt;Кроме того, вы можете просканировать блокчейн Electroneum (и его клонов) самостоятельelectroneumпользуя инструмент electroneum-blockchain-mark-spent-outputs, чтобы создать список известных потраченых выходов.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Чтобы избежать аннулирования защиты, предоставляемой кольцевыми подписями Electroneum, выход не должен быть потраченным с другими значениями размера кольца и на других блокчейнах. Хотя, как правило, это не является проблемой, в некоторых случаях повторное использование ключей Electroneum позволяет потратить существующие выходы. В таких случаях вам необходимо позаботиться, чтобы эти существующие выходы использовали одно и то же кольцо в обеих блокчейнах.&lt;br&gt;Это может быть сделано автоматически с помощью любого программного обеспечения для повторного использования ключей от Electroneum-клонов, и даже если эти клоны не предоставляют подобную защиту, вы все еще можете проверить, что ваши транзакции защищены, путем ручного введения размера кольца на этой странице, которая позволит вам потратить ваши Electroneum безопасно.&lt;br&gt;Если вы не используете программное обеспечения от Electroneum-клонов, вам ничего не нужно делать, так как все будет сделано автоматически.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Здесь записываются кольца, используемые выходами, проводимыми на Electroneum, в цепочке повторного использования ключей, так что одно и то же кольцо можно использовать повторно, чтобы избежать проблем с конфиденциальностью.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Electroneum (например: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Чтобы иметь возможность обмениваться данными с сетью Electroneum, ваш кошелек должен быть подключен к ноде Electroneum. Для лучшей конфиденциальности рекомендуется запустить свою собственную ноду.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Кроме того, вы можете указать ноду быстрой загрузки, чтобы немедленно начать пользоваться Electroneum.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Выберете эту опцию, если вы впервые пользуетесь Electroneum.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Создать новый кошелек, подключившись к вашему аппаратному кошельку Electroneum.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Изменить язык графического интерфейса Electroneum.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Этот режим идеально подходит для управления небольшими суммами Electroneum. У вас есть доступ к основным функциям для совершения транзакций и управления ими. Программа автоматически подключится к сети Electroneum, чтобы вы сразу могли начать использовать Electroneum.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Чтобы иметь возможность обмениваться данными с сетью Electroneum, ваш кошелек должен быть подключен к ноде Electroneum. Для лучшей конфиденциальности рекомендуется запустить свою собственную ноду.
...
Индекс адреса траты: </translation>
    ...
    <message>
        ...
        <translation>Electroneum успешно отправлены: %1 транзакция(й) </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Новая версия Electroneum v.%1 доступна.&lt;br&gt;&lt;br&gt;Скачать:&lt;br&gt;%2&lt;br&gt;&lt;br&gt;SHA256 хэш:&lt;br&gt;%3</translation>
    </message>
    <message>
        <location filename="../main.qml" line="2161"/>
        <source>New version of Electroneum is available. Check out electroneum.com</source>
        <translation>Новая версия Electroneum доступна. Проверьтelectroneumlectroneum.org</translation>
    </message>
    <message>
