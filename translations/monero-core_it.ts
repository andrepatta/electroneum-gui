...
<context>
    ...
    <message>
        ...
        <translation>Al fine di oscurare gli input che vengono spesi in una transazione Electroneum, non deve essere consentito ad un osservatore di individuare in un anello gli input che sono già stati spesi. Essere in grado di fare questo significa indebolire la protezione offerta dalle firme ad anello. Se si fosse a conoscenza del fatto che tutti gli input tranne uno sono già stati spesi, l&apos;input che viene veramente speso sarebbe palese, annullando di fatto l&apos;effetto delle firme ad anello, uno dei tre principali strati di protezione della privacy utilizzati da Electroneum.&lt;br&gt;Per fare in modo che le transazioni escludano tali input, si può ricorrere ad una lista di input di cui è già nota l&apos;avvenuta spesa ed il cui uso può essere evitato in una nuova transazione. Questa lista viene manutenuta dal Progetto Electroneum ed è disponibile sul sito getelectroneum.org; puoi importare la lista qui.&lt;br&gt;Alternativamente, puoi effettuare tu stesso/a una scansione della blockchain (e della blockchain dei cloni di Electroneum che riusano le chiavi) mediante lo strumento electroneum-blockchain-mark-spent-outputs per creare una lista di output già spesi.&lt;br&gt;</translation>
    </message>
    <message>
...
Indice indirizzo di spesa: </translation>
    ...
    <message>
        ...
        <translation>È disponibile una nuova versione di Electroneum. Controlla getelectroneum.org</translation>
    </message>
    <message>
