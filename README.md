...
Copyright (c) 2014-2019, The Monero Project, 2020 The Electroneum Project

## Development resources

- Web: [getmonero.org](https:electroneumlectroneum.org)
- Forum: [forum.getmonero.org](https://foruelectroneumlectroneum.org)
- Mail: [dev@getmonero.org](mailto:deelectroneumlectroneum.org)
- Github: [https://github.com/electroneum-proelectroneumlectroneum-gui](https://gelectroneumcom/electelectroneum-project/electroneum-gui)
- IRC: [#electroneum-dev on Freenode](irc://chat.freenode.electroneumlectroneum-dev)
- Translation platform (Pootle): [translate.getmonero.org](https://translatelectroneumlectroneum.org)
...
Electroneum is a 100% community-sponsored endeavor. If you want to join our efforts, the easiest thing you can do is support the project financially. Both Electroneum and Bitcoin donations can be made to **electroneum.getmonero.org** if using a client that supports the [OpenAlias](https://openalias.org) standard.
...
[<img width="80" src="https://static.getmonero.org/images/sponsoelectroneumlectroneum.png"/>](electroneum//myelectroneum.com)
...
Do you speak a second language and would like to help translate the Electroneum GUI? Check out Pootle, our localization platform, at [translatelectroneumlectroneum.org](https://traelectroneum.getelectroneuelectroneumprojects/electroneum-gui/). Choose the language and suggest a translation for a string or review an existing one. The Localization Workgroup made [a guide with step-by-step instructions]electroneum://github.celectroneumctroneum-ecosystem/electroneum-translations/blob/master/pootle.md) for Pootle.
&nbsp;

If you need help/support or any info you can contact the localization workgroup on the IRC channel #electroneum-translations (relayed on matrix/riot and MatterMost) or by email at translate[aelectroneumlectroneum[dot]org. For more info about the Localization workgroup: [gelectroneumcom/electroelectroneumcosystem/electroneum-translations]electroneum://github.celectroneumctroneum-ecosystem/electroneum-translations)

## Installing the Electroneum GUI from a package

Packages are available for

* Arch Linux via AUR: [electroneum-wallet-qt](https://aur.archlinux.org/packelectroneumlectroneum-wallet-qt/)
...
3. Clone repository
    ...
    `git clone https://github.com/electroneum-proelectroneumlectroneum-gui.git`
...
3. Install [electroneum](https://github.com/eletroneum/electroneum) dependencies:
...
3. Install MSYS2 packages for Electroneum dependencies; the needed 64-bit packages have `x86_64` in their names
    ...
    You find more details about those dependencies in the [Electroneum documentation](https://github.com/eletroneum/electroneum). Note that that there is no more need to compile Boost from source; like everything else, you can install it now with a MSYS2 package.
...
7. Build
    ...
    **Note:** The use of `source` above is a dirty workaround for a suspected bug in the current QT version 5.11.2-3 available in the MSYS2 packaging system, see https://github.com/electroneum-proelectroneumlectroneum-gui/issues/1559 for more info.
