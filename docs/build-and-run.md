## Compiling the Electroneum Desktop Wallet from source
...
The Electroneum Desktop Wallet on Windows is 64 bits only; 32-bit Windows GUI builds are not officially supported anymore.
