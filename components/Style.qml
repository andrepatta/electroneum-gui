...
QtObject {
    ...
    property string electroneumGrey: "#4C4C4C"
    ...
    property string _b_errorColor: "#2ab1f3"
    ...
    property string _b_buttonBackgroundColor: "#2ab1f3"
    property string _b_buttonBackgroundColorHover: "#26a0dc"
    ...
    property string _w_errorColor: "#2ab1f3"
    ...
    property string _w_buttonBackgroundColor: "#2ab1f3"
    property string _w_buttonBackgroundColorHover: "#26a0dc"
