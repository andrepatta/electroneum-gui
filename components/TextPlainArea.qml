...
TextArea {
    ...
    states: [
        State {
            name: "black";
            when: textArea.themeTransition && ElectroneumComponents.Style.blackTheme
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorBlackTheme ? textArea.colorBlackTheme : ElectroneumComponents.Style._b_defaultFontColor
                }
            }
        }, State {
            name: "white";
            ...
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorWhiteTheme ? textArea.colorWhiteTheme : ElectroneumComponents.Style._w_defaultFontColor
                }
            }
        }
    ]
