...
# Base environnement
        ...
        cd electroneum/utils/build_scripts
        docker build -f android32.Dockerfile -t electroneum-android .
        cd ..
...
- Using ADB (Android debugger bridge) : 
  ...
  The only place where we are allowed to play is `/data/local/tmp`. So : 
        ...
        adb  push /opt/android/electroneum-gui/build/release/bin/bin/QtApp-debug.apk /data/local/tmp
