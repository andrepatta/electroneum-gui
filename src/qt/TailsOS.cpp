...
void TailsOS::showDataPersistenceDisabledWarning()
{
    ...
    msgBox.setInformativeText(
        QObject::tr("Electroneum GUI has detected that Tails persistence is "
                     "currently disabled. Any configurations you make inside "
                     "the Electroneum GUI will not be saved."
                     "\n\n"
...
{
    QMessageBox msgBox;
    msgBox.setWindowTitle(QObject::tr("Electroneum GUI"));
